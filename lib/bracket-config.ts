...
export const BRACKET_CONFIGS: Record<number, TournamentConfig> = {
  ...
  16: {
    ...
    // Clasifican: 1os (5), 2os (5), 3ro de A (1) = 11
    // Byes (pasan directo a 4tos): 1A, 1B, 1C, 1D, 1E (5 equipos).
    // Faltan 3 para completar los 8 de 4tos.
    // Juegan 8vos los 6 restantes: 2A, 2B, 2C, 2D, 2E, 3A.
    zonas: [4, 3, 3, 3, 3],
    bracket: [
      // 8vos (3 partidos)
      { ronda: '8vos', posicion: 1, p1: '2A', p2: '2E' },
      { ronda: '8vos', posicion: 2, p1: '2B', p2: '2D' },
      { ronda: '8vos', posicion: 3, p1: '2C', p2: '3A' },

      // 4tos (4 partidos)
      // Partido 1: 1A vs Ganador 8vos-1 (2A/2E) - Evitamos cruce con 2A si es posible, pero 2E es opcion.
      { ronda: '4tos', posicion: 1, p1: '1A', p2: null }, 
      
      // Partido 2: 1B vs Ganador 8vos-2 (2B/2D)
      { ronda: '4tos', posicion: 2, p1: '1B', p2: null }, 
      
      // Partido 3: 1C vs 1D (Duelo de 1ros para reducir de 5 a 4)
      { ronda: '4tos', posicion: 3, p1: '1C', p2: '1D' }, 
      
      // Partido 4: 1E vs Ganador 8vos-3 (2C/3A)
      { ronda: '4tos', posicion: 4, p1: '1E', p2: null }, 

      // Semis
      { ronda: 'semis', posicion: 1, p1: null, p2: null }, // Ganador 4tos-1 vs Ganador 4tos-2
      { ronda: 'semis', posicion: 2, p1: null, p2: null }, // Ganador 4tos-3 vs Ganador 4tos-4
      // Final
      { ronda: 'final', posicion: 1, p1: null, p2: null },
    ],
  },
